...
type PetCategory = 'Dogs' | 'Cats' | 'Small pets'
type PetFilter = 'All friends' | PetCategory
...
const filters = ['All friends', 'Dogs', 'Cats', 'Small pets'] as const satisfies readonly PetFilter[]
...
function App() {
  ...
  const toggleFavorite = (id: Pet['id']) => setFavorites((current) => {
